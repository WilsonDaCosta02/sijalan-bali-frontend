          ...
          <div style={styles.header}>
            <div>
              ...
              <p style={styles.subtitle} className="subtitle-green">
                Lengkapi data di bawah ini untuk melaporkan infrastruktur jalan yang rusak.
              </p>
            </div>
         </div>
...
<div style={styles.uploadBox}>
  ...
  {/* 🔥 KALAU KOSONG */}
  {images.length === 0 && (
    <div style={styles.emptyState} onClick={() => setShowOption(true)}>
...
>
  🔍
        ...
        {images.length < 3 && (
          <div style={styles.addBox} onClick={() => setShowOption(true)}>
      ...
      <small style={{ color: "#94a3b8", marginTop: "8px", display: "block", textAlign: "center" }}>
            ...
            <div style={styles.geoSection}>
              <div style={styles.geoLeft}>
                <div style={{ marginBottom: "8px" }}>
                    <h4 style={{ marginBottom: "4px", color: "white" }}>Data Geospasial*</h4>
